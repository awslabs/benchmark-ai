...
class ExecutorCommandObject:
    ...
    def cancel(self, client_id: str, target_action_id: str, kafka_service: KafkaService, event: CommandRequestEvent):
        for engine in set(self.execution_engines.values()):
            engine.cancel(client_id, target_action_id, kafka_service, event)
