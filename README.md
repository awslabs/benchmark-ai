...
./anubis-setup --region=us-east-1 --prefix-list-id (see amazon prefix list lookup tool)
```
...
```bash
# Assuming PWD is `benchmark-ai`
./anubis-setup --region=us-east-1 --prefix-list-id (see amazon prefix list lookup tool) --destroy
```
